const datapoints = {
    ...
    "tempSensor.sensors[0].value": {
        path: "tempSensor.sensors.0.value", type: "state", common: { name: "Value of measured data, where null = Error and xxxx as xx.xx (Temperature in Celsius degrees. Value need to be divided by 100)", type: "number", role: "text", read: true, write: false }
    },
