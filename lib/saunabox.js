const datapoints = {
    'saunabox#command.state': {
        ...
        type: 'state',
        common: {
            name: '0 - turn off regulator, 1 - turn on regulator',
            type: 'number',
            role: 'value',
            read: true,
            write: true,
    ...
    'saunabox#heat.minimumTemp': {
        path: 'heat.minimumTemp',
        factor: 0.01,
        type: 'state',
        common: {
            name: "saunaBox's minimal Temperature for regulator, minimum value: -55",
            type: 'number',
    ...
    'saunabox#heat.maximumTemp': {
        path: 'heat.maximumTemp',
        factor: 0.01,
        type: 'state',
        common: {
            name: "saunaBox's maximal Temperature for regulator, maximum value: 125",
            type: 'number',
            role: 'value.temperature',
            read: true,
            write: false,
    ...
    'saunabox#heat.state': {
        ...
        type: 'state',
        common: {
            name: 'state of regulator (0 - off, 1 - on)',
            type: 'number',
            role: 'value',
            read: true,
            write: false,
    ...
    'saunabox#heat.desiredTemp': {
        path: 'heat.desiredTemp',
        factor: 0.01,
        type: 'state',
        common: {
            name: "regulator's desired temperature, value between max&min from settings",
            type: 'number',
            role: 'value.temperature',
            read: true,
            write: false,
    ...
    'saunabox#heat.sensors[0].elapsedTimeS': {
        path: 'heat.sensors.0.elapsedTimeS',
        type: 'state',
        common: {
