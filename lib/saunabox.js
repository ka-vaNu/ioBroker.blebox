const datapoints = {
    ...
    "command.desiredTemp": {
        path: "command.desiredTemp", type: "state", common: { name: "temperature in celsius. It should be value between max&min from settings", type: "number", role: "text", read: true, write: true }
    },
    "device.deviceName": {
