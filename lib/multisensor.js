const datapoints = {
    ...
    'multisensor#multiSensor.sensors[4].elapsedTimeS': {
        path: 'multiSensor.sensors.4.elapsedTimeS',
        type: 'state',
        common: {
            name: 'Time in seconds that has elapsed since last valid measurement occurred, where -1 = Error, 0 = Fresh data',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[4].state': {
        path: 'multiSensor.sensors.4.state',
        type: 'state',
        common: {
            name: 'Status of sensor, where 1 = Measure in progress, 2 = Active Mode, 3 = Error',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[4].trend': {
        path: 'multiSensor.sensors.4.trend',
        type: 'state',
        common: {
            name: 'Trend of measured data, where 0 = no data, 1 = sidewave, 2 = Downward, 3 = Upward',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[4].value': {
        path: 'multiSensor.sensors.4.value',
        factor: 0.01,
        type: 'state',
        common: {
            name: 'Value of measured data, where null = Error and Temperature in Celsius degrees.',
    ...
    'multisensor#multiSensor.sensors[4].type': {
        path: 'multiSensor.sensors.4.type',
        type: 'state',
        common: { name: 'Type of measured value', type: 'string', role: 'text', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[4].id': {
        path: 'multiSensor.sensors.4.id',
        type: 'state',
        common: { name: 'ID of internal sensor', type: 'number', role: 'value', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[4].iconSet': {
        path: 'multiSensor.sensors.4.iconSet',
        type: 'state',
        common: { name: 'Type of icon', type: 'number', role: 'value', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[4].name': {
        path: 'multiSensor.sensors.4.name',
        type: 'state',
        common: { name: 'Personalized name of the sensor', type: 'string', role: 'text', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[5].elapsedTimeS': {
        path: 'multiSensor.sensors.5.elapsedTimeS',
        type: 'state',
        common: {
            name: 'Time in seconds that has elapsed since last valid measurement occurred, where -1 = Error, 0 = Fresh data',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[5].state': {
        path: 'multiSensor.sensors.5.state',
        type: 'state',
        common: {
            name: 'Status of sensor, where 1 = Measure in progress, 2 = Active Mode, 3 = Error',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[5].trend': {
        path: 'multiSensor.sensors.5.trend',
        type: 'state',
        common: {
            name: 'Trend of measured data, where 0 = no data, 1 = sidewave, 2 = Downward, 3 = Upward',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[5].value': {
        path: 'multiSensor.sensors.5.value',
        factor: 0.01,
        type: 'state',
        common: {
            name: 'Value of measured data, where null = Error and Temperature in Celsius degrees.',
    ...
    'multisensor#multiSensor.sensors[5].type': {
        path: 'multiSensor.sensors.5.type',
        type: 'state',
        common: { name: 'Type of measured value', type: 'string', role: 'text', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[5].id': {
        path: 'multiSensor.sensors.5.id',
        type: 'state',
        common: { name: 'ID of internal sensor', type: 'number', role: 'value', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[5].iconSet': {
        path: 'multiSensor.sensors.5.iconSet',
        type: 'state',
        common: { name: 'Type of icon', type: 'number', role: 'value', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[5].name': {
        path: 'multiSensor.sensors.5.name',
        type: 'state',
        common: { name: 'Personalized name of the sensor', type: 'string', role: 'text', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[6].elapsedTimeS': {
        path: 'multiSensor.sensors.6.elapsedTimeS',
        type: 'state',
        common: {
            name: 'Time in seconds that has elapsed since last valid measurement occurred, where -1 = Error, 0 = Fresh data',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[6].state': {
        path: 'multiSensor.sensors.6.state',
        type: 'state',
        common: {
            name: 'Status of sensor, where 1 = Measure in progress, 2 = Active Mode, 3 = Error',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[6].trend': {
        path: 'multiSensor.sensors.6.trend',
        type: 'state',
        common: {
            name: 'Trend of measured data, where 0 = no data, 1 = sidewave, 2 = Downward, 3 = Upward',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[6].value': {
        path: 'multiSensor.sensors.6.value',
        factor: 0.01,
        type: 'state',
        common: {
            name: 'Value of measured data, where null = Error and Temperature in Celsius degrees.',
    ...
    'multisensor#multiSensor.sensors[6].type': {
        path: 'multiSensor.sensors.6.type',
        type: 'state',
        common: { name: 'Type of measured value', type: 'string', role: 'text', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[6].id': {
        path: 'multiSensor.sensors.6.id',
        type: 'state',
        common: { name: 'ID of internal sensor', type: 'number', role: 'value', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[6].iconSet': {
        path: 'multiSensor.sensors.6.iconSet',
        type: 'state',
        common: { name: 'Type of icon', type: 'number', role: 'value', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[6].name': {
        path: 'multiSensor.sensors.6.name',
        type: 'state',
        common: { name: 'Personalized name of the sensor', type: 'string', role: 'text', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[7].elapsedTimeS': {
    ...
    'multisensor#multiSensor.sensors[7].state': {
        path: 'multiSensor.sensors.7.state',
        type: 'state',
        common: {
            name: 'Status of sensor, where 1 = Measure in progress, 2 = Active Mode, 3 = Error',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[7].trend': {
        path: 'multiSensor.sensors.7.trend',
        type: 'state',
        common: {
            name: 'Trend of measured data, where 0 = no data, 1 = sidewave, 2 = Downward, 3 = Upward',
            type: 'number',
    ...
    'multisensor#multiSensor.sensors[7].value': {
        path: 'multiSensor.sensors.7.value',
        factor: 0.01,
        type: 'state',
        common: {
            name: 'Value of measured data, where null = Error and Temperature in Celsius degrees.',
    ...
    'multisensor#multiSensor.sensors[7].type': {
        path: 'multiSensor.sensors.7.type',
        type: 'state',
        common: { name: 'Type of measured value', type: 'string', role: 'text', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[7].id': {
        path: 'multiSensor.sensors.7.id',
        type: 'state',
        common: { name: 'ID of internal sensor', type: 'number', role: 'value', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[7].iconSet': {
        path: 'multiSensor.sensors.7.iconSet',
        type: 'state',
        common: { name: 'Type of icon', type: 'number', role: 'value', read: true, write: false },
    },
    'multisensor#multiSensor.sensors[7].name': {
        path: 'multiSensor.sensors.7.name',
        type: 'state',
        common: { name: 'Personalized name of the sensor', type: 'string', role: 'text', read: true, write: false },
    },
};
