const datapoints = {
    ...
    'switchboxD#sensors[0].trend': {
        path: 'sensors.0.trend',
        type: 'state',
        common: {
            name: 'Trend - not used, always 0',
            type: 'number',
            role: 'value',
            read: true,
            write: false,
    ...
    'switchboxD#sensors[0].state': {
        path: 'sensors.0.trend',
        type: 'state',
        common: {
            name: 'Active mode without error reporting (if 4 occurs then it is always 4)',
            type: 'number',
            role: 'value',
            read: true,
            write: false,
