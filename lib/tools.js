...
const datapoints = {
	...
	"command.position": { name: "move to position 0-100", type: "state", role: "text", read: true, write: true },
	...
	"shutter.currentPos.position": { name: "Current shutter position. Value from 0 to 100 or -1 - unknown.", type: "state", role: "text", read: true, write: false },
