...
const datapoints = {
	...
	"device.deviceName": { name: "Devicename", type: "state", role: "text", read: true, write: true },
	...
	"uptimeS": { name: "Uptime in seconds", type: "state", role: "number", read: true, write: false },
