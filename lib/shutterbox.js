const datapoints = {
    "command.move": {
        type: "state", common: { name: "move up (u) or down (d)", type: "state", role: "text", read: true, write: true }
    },
    "command.favorite": {
        type: "state", common: { name: "move to favorite-position 1-4", type: "state", role: "text", read: true, write: true }
    },
    "command.position": {
        type: "state", common: { name: "move to position 0-100", type: "state", role: "text", read: true, write: true }
    },
    "command.tilt": {
        type: "state", common: { name: "tilt-command", type: "state", role: "text", read: true, write: true }
    },
    "device.deviceName": {
