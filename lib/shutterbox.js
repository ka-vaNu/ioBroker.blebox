const datapoints = {
    "shutterbox#command.move": {
        path: "command.move", type: "state", common: { name: "move up (u), down (d), stop (s)", type: "string", role: "text", read: true, write: true }
    },
    ...
    "shutterbox#settings.statusLed.enabled": {
        path: "settings.statusLed.enabled", type: "state", common: { name: "Status led enabled (0 - disabled, 1 - enabled)", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#settings.tunnel.enabled": {
        path: "settings.tunnel.enabled", type: "state", common: { name: "Tunnel enabled (0 - disabled, 1 - enabled)", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#settings.shutter.controlType": {
        path: "settings.shutter.controlType", type: "state", common: { name: "Type of controlled appliance. Where: 1 - segmented shutter, 2 - appliance without positioning, 3 - tilt shutter, 4 - window opener, 5, material shutter, 6 - awning, 7 - screen.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#settings.shutter.moveTimeoutMs": {
        path: "settings.shutter.moveTimeoutMs", type: "state", common: { name: "Max time moving shutter in any direction in miliseconds.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#settings.shutter.moveDirectionSwap": {
        path: "settings.shutter.moveDirectionSwap", type: "state", common: { name: "Move direction swap. Where: 0 - false, 1 - true.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#settings.shutter.inputsSwap": {
        path: "settings.shutter.inputsSwap", type: "state", common: { name: "Inputs swap. Where: 0 - false, 1 - true.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#settings.shutter.calibrationParameters.isCalibarted": {
        path: "settings.shutter.calibrationParameters.isCalibarted", type: "state", common: { name: "Information about shutter calibration. Where: 0 - not calibrated, 1 - calibrated.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#settings.shutter.calibrationParameters.maxTiltTimeDownMs": {
        path: "settings.shutter.calibrationParameters.maxTiltTimeDownMs", type: "state", common: { name: "Max tilt time up in miliseconds.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#settings.shutter.calibrationParameters.maxTiltTimeUpMs": {
        path: "settings.shutter.calibrationParameters.maxTiltTimeUpMs", type: "state", common: { name: "Max tilt time down in miliseconds.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#shutter.state": {
        path: "shutter.state", type: "state", common: { name: "Current shutter state. Where: 0 - Moving down, 1 - Moving up, 2 - Manually stopped, 3 - Lower limit, 4 - Upper limit.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#shutter.currentPos.position": {
        path: "shutter.currentPos.position", type: "state", common: { name: "Current shutter position. Value from 0 to 100 or -1 - unknown.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#shutter.currentPos.tilt": {
        path: "shutter.currentPos.tilt", type: "state", common: { name: "Current tilt. Value from 0 to 100 or -1 - unknown.", type: "number", role: "text", read: true, write: true }
    },
    ...
    "shutterbox#shutter.desiredPos.tilt": {
        path: "shutter.desiredPos.tilt", type: "state", common: { name: "Desired tilt. Value from 0 to 100 or -1 - unknown.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#shutter.favPos.position": {
        path: "shutter.favPos.position", type: "state", common: { name: "Favorite shutter position. Value from 0 to 100 or -1 - unknown.", type: "number", role: "text", read: true, write: true }
    },
    "shutterbox#shutter.favPos.tilt": {
        path: "shutter.favPos.tilt", type: "state", common: { name: "Favorite tilt. Value from 0 to 100 or -1 - unknown.", type: "number", role: "text", read: true, write: true }
    }
};
